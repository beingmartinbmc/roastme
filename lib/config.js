...
const { DEFAULT_CONFIG, ROAST_MODES, FILE_PATTERNS, ISSUE_TYPES } = require('./constants');
...
function validateConfig(config) {
  const validModes = Object.values(ROAST_MODES);
  const validTargets = ['code', 'commit', 'staged'];
  const validChecks = Object.values(ISSUE_TYPES);
